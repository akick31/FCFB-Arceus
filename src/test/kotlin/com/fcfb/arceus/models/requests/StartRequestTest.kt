...
class StartRequestTest {
    ...
    fun `StartRequest should create instance with all properties`() {
        ...
        assertEquals(Platform.DISCORD, startRequest.homePlatform)
        assertEquals(Platform.DISCORD, startRequest.awayPlatform)
    ...
    fun `StartRequest should handle different Platform enum values`() {
        ...
        assertEquals(Platform.DISCORD, discordRequest.homePlatform)
        assertEquals(Platform.DISCORD, discordRequest.awayPlatform)
    }
