...
class TeamTest {
    ...
    fun `test Team parameterized constructor`() {
        ...
        val team =
            Team(
                ...
                conference = Team.Conference.SEC,
                currentWins = 8,
                currentLosses = 2,
                overallWins = 25,
                overallLosses = 10,
        ...
        assertEquals(Team.Conference.SEC, team.conference)
    ...
    fun `test Team property mutability`() {
        ...
        team.conference = Team.Conference.BIG_TEN
        team.currentWins = 12
        ...
        assertEquals(Team.Conference.BIG_TEN, team.conference)
    ...
    fun `test Conference enum values`() {
        assertEquals("ACC", Team.Conference.ACC.description)
        assertEquals("American", Team.Conference.AMERICAN.description)
        assertEquals("Big 12", Team.Conference.BIG_12.description)
        assertEquals("Big Ten", Team.Conference.BIG_TEN.description)
        assertEquals("C-USA", Team.Conference.CUSA.description)
        assertEquals("Fake Team", Team.Conference.FAKE_TEAM.description)
        assertEquals("FBS Independent", Team.Conference.FBS_INDEPENDENT.description)
        assertEquals("MAC", Team.Conference.MAC.description)
        assertEquals("Mountain West", Team.Conference.MOUNTAIN_WEST.description)
        assertEquals("Pac-12", Team.Conference.PAC_12.description)
        assertEquals("SEC", Team.Conference.SEC.description)
        assertEquals("Sun Belt", Team.Conference.SUN_BELT.description)
        assertEquals("Atlantic Sun", Team.Conference.ATLANTIC_SUN.description)
        assertEquals("Big Sky", Team.Conference.BIG_SKY.description)
        assertEquals("Carolina Football Conference", Team.Conference.CAROLINA_FOOTBALL_CONFERENCE.description)
        assertEquals("Missouri Valley", Team.Conference.MISSOURI_VALLEY.description)
        assertEquals("Colonial", Team.Conference.COLONIAL.description)
        assertEquals("NEC", Team.Conference.NEC.description)
        assertEquals("Ivy League", Team.Conference.IVY_LEAGUE.description)
        assertEquals("Mid-Atlantic", Team.Conference.MID_ATLANTIC.description)
        assertEquals("Southland", Team.Conference.SOUTHLAND.description)
        assertEquals("Ohio Valley", Team.Conference.OHIO_VALLEY.description)
        assertEquals("SWAC", Team.Conference.SWAC.description)
    }

    @Test
    fun `test Conference fromString method`() {
        assertEquals(Team.Conference.ACC, Team.Conference.fromString("ACC"))
        assertEquals(Team.Conference.SEC, Team.Conference.fromString("SEC"))
        assertEquals(Team.Conference.BIG_TEN, Team.Conference.fromString("Big Ten"))
        assertEquals(Team.Conference.PAC_12, Team.Conference.fromString("Pac-12"))
        assertEquals(Team.Conference.FBS_INDEPENDENT, Team.Conference.fromString("FBS Independent"))
        assertNull(Team.Conference.fromString("Invalid Conference"))
    }
    ...
    fun `test Team with all conference values`() {
        ...
        Team.Conference.entries.forEach { conference ->
