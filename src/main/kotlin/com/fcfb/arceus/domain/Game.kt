...
class Game {
    ...
    enum class Scenario(val description: String) {
        ...
        SAFETY("SAFETY"),
        FUMBLE("FUMBLE"),
        FIVE_YARD_LINE("5 YARD LINE"),
        TEN_YARD_LINE("10 YARD LINE"),
        TWENTY_YARD_LINE("20 YARD LINE"),
        THIRTY_YARD_LINE("30 YARD LINE"),
        THIRTY_FIVE_YARD_LINE("35 YARD LINE"),
        FOURTY_YARD_LINE("40 YARD LINE"),
        FOURTY_FIVE_YARD_LINE("45 YARD LINE"),
        FIFTY_YARD_LINE("50 YARD LINE"),
        SIXTY_FIVE_YARD_LINE("65 YARD LINE"),
        TOUCHBACK("TOUCHBACK"),
