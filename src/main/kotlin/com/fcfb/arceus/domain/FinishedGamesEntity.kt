...
@Entity
@Table(name = "finished_games", schema = "arceus")
class FinishedGamesEntity {
    ...
    constructor(
        ...
        homeCoach: String?,
        awayCoach: String?,
        homeOffensivePlaybook: String?,
        awayOffensivePlaybook: String?,
        homeDefensivePlaybook: String?,
        awayDefensivePlaybook: String?,
        season: Int?,
        week: Int?,
        subdivision: String?,
        homeScore: Int?,
        ...
        homePassCompletionPercentage: Double?,
        homePassYards: Int?,
        awayPassAttempts: Int?,
        awayPassCompletions: Int?,
        awayPassCompletionPercentage: Double?,
        awayPassYards: Int?,
        homeRushAttempts: Int?,
        homeRush3YardsOrMore: Int?,
        homeRushSuccessPercentage: Double?,
        homeRushYards: Int?,
        awayRushAttempts: Int?,
        awayRush3YardsOrMore: Int?,
        awayRushSuccessPercentage: Double?,
        awayRushYards: Int?,
        homeTotalYards: Int?,
        awayTotalYards: Int?,
        homeInterceptionsLost: Int?,
        homeFumblesLost: Int?,
        homeTurnoversLost: Int?,
        homeTurnoverTouchdownsLost: Int?,
        awayInterceptionsLost: Int?,
        awayHomeFumblesLost: Int?,
        awayHomeTurnoversLost: Int?,
        awayTurnoverTouchdownsLost: Int?,
        homeFieldGoalMade: Int?,
        homeFieldGoalAttempts: Int?,
        homeFieldGoalPercentage: Double?,
        homeLongestFieldGoal: Int?,
        homeBlockedOpponentFieldGoals: Int?,
        homeFieldGoalTouchdown: Int?,
        awayFieldGoalMade: Int?,
        awayFieldGoalAttempts: Int?,
        awayFieldGoalPercentage: Double?,
        awayLongestFieldGoal: Int?,
        awayBlockedOpponentFieldGoals: Int?,
        awayFieldGoalTouchdown: Int?,
        homePuntsAttempted: Int?,
        homeLongestPunt: Int?,
        homeAveragePuntLength: Double?,
        homeBlockedOpponentPunt: Int?,
        homePuntReturnTd: Int?,
        homePuntReturnTdPercentage: Double?,
        awayPuntsAttempted: Int?,
        awayLongestPunt: Int?,
        awayAveragePuntLength: Double?,
        awayBlockedOpponentPunt: Int?,
        awayPuntReturnTd: Int?,
        awayPuntReturnTdPercentage: Double?,
        homeNumberOfKickoffs: Int?,
        homeOnsideAttempts: Int?,
        homeOnsideSuccess: Int?,
        homeOnsideSuccessPercentage: Double?,
        homeNormalKickoffAttempts: Int?,
        homeTouchbacks: Int?,
        homeTouchbackPercentage: Double?,
        homeKickReturnTd: Int?,
        homeKickReturnTdPercentage: Double?,
        awayNumberOfKickoffs: Int?,
        awayOnsideAttempts: Int?,
        awayOnsideSuccess: Int?,
        awayOnsideSuccessPercentage: Double?,
        awayNormalKickoffAttempts: Int?,
        awayTouchbacks: Int?,
        awayTouchbackPercentage: Double?,
        awayKickReturnTd: Int?,
        awayKickReturnTdPercentage: Double?,
        homeNumberOfDrives: Int?,
        homeNumberOfTdDrives: Int?,
        homeTdDrivePercentage: Double?,
        homeNumberOfFgDrives: Int?,
        homeFgDrivePercentage: Double?,
        homeNumberOfPuntDrives: Int?,
        homePuntDrivePercentage: Double?,
        homeNumberOfTurnoverDrives: Int?,
        homeTurnoverDrivePercentage: Double?,
        awayNumberOfDrives: Int?,
        awayNumberOfTdDrives: Int?,
        awayTdDrivePercentage: Double?,
        awayNumberOfFgDrives: Int?,
        awayFgDrivePercentage: Double?,
        awayNumberOfPuntDrives: Int?,
        awayPuntDrivePercentage: Double?,
        awayNumberOfTurnoverDrives: Int?,
        awayTurnoverDrivePercentage: Double?,
        ...
        scorePlotGraph: String?,
        statsUpdated: Boolean?,
        averageHomeOffensiveDiff: Double?,
        averageHomeDefensiveDiff: Double?,
        averageHomeSpecialteamsDiff: Double?,
        averageAwayOffensiveDiff: Double?,
        averageAwayDefensiveDiff: Double?,
        averageAwaySpecialteamsDiff: Double?,
        homeAverageYardsPerPlay: Double?,
        awayAverageYardsPerPlay: Double?,
        homeThirdDownConversionSuccess: Int?,
        homeThirdDownConversionAttempts: Int?,
        homeThirdDownConversionPercentage: Double?,
        homeFourthDownConversionSuccess: Int?,
        homeFourthDownConversionAttempts: Int?,
        homeFourthDownConversionPercentage: Double?,
        awayThirdDownConversionSuccess: Int?,
        awayThirdDownConversionAttempts: Int?,
        awayThirdDownConversionPercentage: Double?,
        awayFourthDownConversionSuccess: Int?,
        awayFourthDownConversionAttempts: Int?,
        awayFourthDownConversionPercentage: Double?,
        homeLargestLead: Int?,
        awayLargestLead: Int?,
        homePassTouchdowns: Int?,
        homeRushTouchdowns: Int?,
        awayPassTouchdowns: Int?,
        awayRushTouchdowns: Int?,
        homeBlockedOpponentPuntTd: Int?,
        awayBlockedOpponentPuntTd: Int?,
        homeRecord: String?,
        awayRecord: String?,
        isScrimmage: Boolean?,
        isFinal: Boolean?
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val that = o as FinishedGamesEntity
